export const consultingSWContent = [
  {
    ...
    description:
      ...
      De ser helheten, hittar mönster och formar lösningar som håller – även när behoven \
  ...
  },
  {
    ...
    description:
      ...
      verifierar. Våra testare är nyfikna upptäckare som vet att kvalitet \
      inte handlar om att aldrig göra misstag, utan om att alltid lära sig \
      av dem. De testar med både hjärta och hjärna – för att våra kunder \
  ...
  },
  {
    ...
    description:
      ...
      sunt förnuft för att guida från första idé till fungerande lösning. Ibland \
      handlar det om att bygga eget, ibland om att välja rätt verktyg – och \
  ...
  },
  {
    ...
    description:
      ...
      Vi gillar automation, pipelines och tydliga flöden som gör vardagen \
      lättare för alla i teamet. Devops för oss är inte bara teknik, det är ett \
